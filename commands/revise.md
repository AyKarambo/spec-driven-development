...
3. Apply the requested change to the correct section, preserving the others and all marker pairs:
   - **spec (user story)** → present the revised body sections for review, then after I approve edit the issue body (`gh issue edit <n> --body-file .claude/sdd/issue-body.md`, then delete the temp file).
   ...
   Present the revision for review, then push the updated body (`gh issue edit <n> --body-file .claude/sdd/issue-body.md`, then delete the temp file) only after I approve.
