...
(The autonomous counterpart is `/sdd-auto`: once the spec is approved, it runs all remaining steps through review and PR without stopping. `/next` deliberately stays single-step.)
